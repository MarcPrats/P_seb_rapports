...
%  \begin{center}
   \subfloat{
   \includegraphics[width=0.2\textwidth]{figures/logo_ENSEIRB.pdf}
   }\hspace{11cm}
   \subfloat{
   \includegraphics[width=0.2\textwidth]{figures/logo_SMARTEE.pdf}
   }
%  \end{center}
\end{figure}
}
...
\title{\Large{\bf{Smartee\\ Smart, Eco-friendly \& Economic Box\\ \textsc{Technical Documentation}}}}
...
\begin{abstract}
\noindent The aim of this document is to introduce the Smart Eco-Box project. This Smart Eco-Box is called Smartee and it can connect to the user's sensors to help him regulate his energy consumption. The biggest challenge in designing the box was to display the devices energy consumption in a  web application and to detect whether the sensors are on or off. The workload was splitted between two teams: one tacking care of signal processing and the other one of the webapp design. The signal processing part dealt with the signal emission by the sensors, the analysis of transmitted data and the detection of the devices. A user-friendly interface also had been design to display in an ergonomic and understandable manner the information retrieved thanks to the signal processing.\\\\

This document is a technical documentation, for helping teams working on our work. Please keep in mind that our code is well commented, and that there is always readme.md, that can help you understand how it works.
